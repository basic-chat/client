...
var ThemeRoot = base_1.componentFactory({
    displayName: 'ThemeRoot',
    tag: 'span'
});
/** A Theme Component. */
exports.Theme = function (_a) {
    var use = _a.use, wrap = _a.wrap, rest = __rest(_a, ["use", "wrap"]);
    if (wrap) {
        return base_1.wrapChild(__assign({}, rest, { className: base_1.parseThemeOptions(use).join(' ') }));
    }
    return React.createElement(ThemeRoot, __assign({ theme: use }, rest));
};
exports.Theme.displayName = 'Theme';
    ...
    Object.defineProperty(ThemeProvider.prototype, "colors", {
        get: function () {
            ...
            if (parsed !== this.prevOpts_) {
                ...
                this.colors_ = utils_1.getAutoColorsForTheme(processedColors);
            }
            return this.colors_;
        },
        enumerable: true,
