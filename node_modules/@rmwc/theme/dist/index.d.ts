...
export declare const Theme: {
    ({ use, wrap, ...rest }: RMWC.MergeInterfacesT<ThemeProps, RMWC.ComponentProps>): JSX.Element;
    displayName: string;
};
/** A ThemeProvider. This sets theme colors for its child tree. */
export interface ThemeProviderProps extends Pick<RMWC.ComponentProps, Exclude<keyof RMWC.ComponentProps, 'wrap'>> {
