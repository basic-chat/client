...
export default function () {
    return (React.createElement(Docs, { title: "Avatars", lead: "Avatars are virtual representations of users in a system.", module: "@rmwc/avatar", styles: ['@rmwc/avatar/avatar.css'], examples: examples, addon: true },
        ...
        React.createElement(DocProps, { src: propsSrc, components: [Avatar, AvatarGroup, AvatarCount] })));
}
